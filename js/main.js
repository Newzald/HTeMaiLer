$(function () {
    ...
    function getHours(hoursResponse) {
        $.ajax({
            type: "GET",
            url: "hours.php",
            success: function(response) {
    ...
    e.preventDefault();
        ...
        $.ajax({
            ...
            getHours(function(output){
                var $hours = {};
                $hours.monday       = output[0].mon;
                $hours.tuesday      = output[0].tue;
                $hours.wednesday    = output[0].wed;
                $hours.thursday     = output[0].thu;
                $hours.friday       = output[0].fri;
